...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::patch('/extra-categories', [ExtraCategoriesController::class, 'update']);
    ...
    Route::post('/products/{product}/add-extra/{extraCategory}', [ProductsController::class, 'addExtra']);
    Route::post('/products/{product}/remove-extra', [ProductsController::class, 'removeExtra']);
    Route::post('/products/{product}/add-ingredient/{ingredient}', [ProductsController::class, 'addIngredient']);
    Route::post('/products/{product}/remove-ingredient/{ingredient}', [ProductsController::class, 'removeIngredient']);
